...
export default function AgriculturePage() {
  ...
  return (
    <>
      <Navbar />
      <div className="pt-20 px-4 sm:px-6 md:px-8 bg-gray-100 min-h-screen animate__animated animate__fadeIn">
        <div className="max-w-7xl mx-auto">
          {/* Title */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl mt-10 font-bold text-[#1a2a6c] mb-8 inline-block relative">
          ...
          <div className="relative rounded-xl overflow-hidden mb-12">
            <img
              ...
              className="w-full h-48 sm:h-60 md:h-auto rounded-xl shadow-lg transform transition-transform duration-500 hover:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent"></div>
            <div className="absolute bottom-0 left-0 p-3 sm:p-6 md:p-8 text-white">
              <h1 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-1">AGRONE-X</h1>
              <p className="text-xs sm:text-sm md:text-lg">India's Premier Agricultural Drone Solution</p>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <span className="bg-yellow-400 text-gray-800 px-3 py-1 rounded-full text-xs sm:text-sm font-bold">10L Capacity</span>
                <span className="bg-[#1a2a6c] text-white px-3 py-1 rounded-full text-xs sm:text-sm font-bold">Hexacopter</span>
                <span className="bg-[#b21f1f] text-white px-3 py-1 rounded-full text-xs sm:text-sm font-bold">DGCA Certified</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {features.map((feature, index) => (
              ...
              >
                <i className={`${feature.icon} text-xl sm:text-2xl lg:text-3xl text-[#b21f1f] mb-4`}></i>
                <h4 className="text-base sm:text-lg font-semibold text-[#1a2a6c] mb-2">{feature.title}</h4>
          ...
          <div className="bg-gray-100 rounded-lg shadow-lg p-4 sm:p-6 mb-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {specifications.map((spec, index) => (
                <div key={index} className="flex items-start">
                  <i className={`${spec.icon} text-lg sm:text-xl md:text-2xl text-[#b21f1f] mr-3 mt-1`}></i>
                  <div>
                    <h4 className="text-sm sm:text-base font-semibold text-[#1a2a6c]">{spec.name}</h4>
                    <p className="text-xs sm:text-sm text-gray-700">{spec.value}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-6 pt-4 border-t border-gray-200 flex flex-wrap gap-2">
              <span className="bg-[#1a2a6c] text-white px-3 py-1 rounded-full text-xs sm:text-sm">DGCA Category: Small</span>
              <span className="bg-[#b21f1f] text-white px-3 py-1 rounded-full text-xs sm:text-sm">Dimensions: 1300×1300×550mm</span>
              <span className="bg-yellow-400 text-gray-800 px-3 py-1 rounded-full text-xs sm:text-sm">Weight: 9.8kg (without battery)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div>
              ...
              />
              <h4 className="text-base sm:text-lg font-semibold text-[#1a2a6c] mt-4">Hexacopter Design</h4>
              <p className="text-sm sm:text-base text-gray-700">Unfolded dimensions: 1300×1300×550mm</p>
            </div>
            <div>
              <img
                ...
                className="w-full rounded-xl shadow-lg transform transition-transform duration-500 hover:scale-105"
              />
              <h4 className="text-base sm:text-lg font-semibold text-[#1a2a6c] mt-4">Folding Mechanism</h4>
              <p className="text-sm sm:text-base text-gray-700">Folded dimensions: 600×600×500mm for easy transport</p>
            </div>
          </div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <i className={`${service.icon} text-lg sm:text-xl md:text-2xl text-[#b21f1f] mb-3`}></i>
                  <h4 className="text-base sm:text-lg font-semibold text-[#1a2a6c] mb-2">{service.title}</h4>
